...
$(document).ready(function(){
        ...
        view: new ol.View({ // 지도가 보여 줄 중심좌표, 축소, 확대 등을 설정한다. 보통은 줌, 중심좌표를 설정하는 경우가 많다.
            ...
            zoom: 7.7,
            minZoom : 7.7, // 최소 확대 Zoom[줌 아웃을 할 수 있는 최대 단계]
            maxZoom : 17 // 최대 확대 Zoom [줌 인 할 수 있는 최대 단계]
        })
    });
...
<div class="container-fluid d-flex flex-column my-4" style="height: 100%;">
        ...
        <div class="col-md-4 d-flex flex-column pe-0">
            ...
            <div class="row">
                <div class="col-md-3 border border-dark border-end-0 border-top-0 p-0">
                        <div class="cmap align-middle border-bottom border-dark py-2" id="menu">
                            <i class="bi bi-geo-alt fs-5 ps-4"></i>탄소지도
                        </div>
                        <div class="upLoad align-middle border-bottom border-dark py-2" id="menu">
                            <i class="bi bi-upload fs-5 ps-3 pe-1"></i>데이터 삽입
                        </div>
                        <div class="statistic align-middle border-bottom border-dark py-2" id="menu">
                            <i class="bi bi-bar-chart-line fs-5 ps-3 pe-1"></i>통계
                        </div>
                </div>
